...
let beneficios = parseFloat(gets());

function calculaSalarioLiq(salario, beneficios) {
  if (salario > 0 && salario <= 1100.0) {
    const imposto = salario * 0.05;
    salario = salario - imposto + beneficios;
    return salario;
  } else if (salario >= 1100.01 && salario <= 2500.0) {
    const imposto = salario * 0.1;
    salario = salario - imposto + beneficios;
    return salario;
  } else {
...
print(calculaSalarioLiq(salario,beneficios));